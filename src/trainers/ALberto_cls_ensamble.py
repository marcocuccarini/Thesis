...
class BertClsTrainer():
    ...
    def fit(self, model1, model2, train_dataset, val_dataset, batch_size1, lr1, n_epochs1, loss_fn1, batch_size2, lr2, n_epochs2, loss_fn2):
        ...
        optimizer1 = torch.optim.AdamW(model.parameters(), lr=lr1)
        optimizer2 = torch.optim.AdamW(model.parameters(), lr=lr2)
